...
export class News extends Component {
    ...
    async updateNews(pageNo){
        const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apikey=19a013882c314520a9c2da8688d668d5&page=${this.state.page}&pageSize=${this.props.pageSize}`;
